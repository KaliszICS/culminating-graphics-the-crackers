...
public class MapData {
    private static Tile gras = new Tile(new Image("Sprites/Grass.png",45.0 , 45.0, true, false), false);
    private static Tile tree = new Tile(new Image("Sprites/Tree.png",45.0 , 45.0, true, false), true);
    ...
    private static Tile[][] GRASSLANDS_GRID = new Tile[][]{
        ...
        {gras,gras,gras,gras,gras,gras,gras,gras,gras,gras,},
        {gras,gras,gras,gras,gras,gras,gras,gras,gras,gras,},
    }; //FRICK FRICK FRICK FRICK FRICK, ITS COMPLETELY FLIPPED DIAGONALLY
